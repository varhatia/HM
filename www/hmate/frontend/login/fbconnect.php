...
$my_url = "https://localhost/frontend/login/fbconnect.php";           // Same Site URL as in point 7, also same as the path of this file where it resides in the server.
...
// 	echo '<pre>';print_r($userFriends);echo '</pre>';
	...
	if($count==1){
		...
		header("location:../index.php"); // redirect the page...
	}
	else {
