...
$selectTypeEvents = "select `organization` from `userdetail` where `uid` = $uid";
...
$selectothers = "select uid from `userdetail` where `organization` = '$org'";
...
if(mysql_fetch_array($hobbyEvents) != 1)
{
