				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4">
							<h2>
								<strong> <?php include 'details/showConnections.php'; ?> </strong>
							</h2>
							<p>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<?php
							include 'details/displayFriends.php';
							?>
						</div>
							...
							<tr>
								<td>
									<div id="onPageLoad">
										...
										<?php
										include 'details/displayGreetings.php';
										?>
									</div>
		...
		<div>
			<div id="eventsParticipated" class="col-md-3 column">
				<div class="jumbotron well">
					...
					<div>
						<?php include 'details/showActivitiesParticipated.php';?>
					</div>
				</div>
			</div>
		...
		<div>
			<div id="eventStarted" class="col-md-3 column">
				<div class="jumbotron well">
					...
					<div>
						<?php include 'details/showStarted.php';?>
					</div>
				</div>
			</div>
		</div>
